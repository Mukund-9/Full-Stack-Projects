...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      <img src={authUser.profilePic||assets.logo_icon} className={`max-w-40 mt-5 md:max-w-44 aspect-square rounded-full mx-10 md:max-sm:mt-10 ${selectedImg&& 'rounded-full '}`} />
      </div>
